...
//           query.setParameter("codigoUsuario", cliente);
    ...
    public List<Cliente> FindClienteLikeNombre(String buscar) {
        ...
        try {
            ...
            em = HelperPersistencia.getEMF();
            em.getTransaction().begin();
            Query query = em.createQuery("SELECT c FROM Cliente c WHERE c.cliNombre like :cliNombre ORDER BY c.cliNombre ASC");
    ...
    /*verifica cliente en propietario*/
    
    public Cliente FindClienteForCedulaPropietario(String buscar) {
        ...
        try {
            ...
            System.out.println("Error en la consulta cliente FindClienteForCedulaPropietario "+e.getMessage());
        } finally {
            em.close();
        }

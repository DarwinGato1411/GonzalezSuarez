...
public class ServicioPredio {
    ...
    public List<Predio> findLikePreDireccionCedulaNombre(String valor) {
        ...
        try {
            ...
            em = HelperPersistencia.getEMF();
            em.getTransaction().begin();
            Query query = em.createQuery("SELECT  a FROM Predio a WHERE a.predDireccion LIKE :predDireccion OR a.idPropietario.porpCedula LIKE :porpCedula OR a.idPropietario.propNombre LIKE :propNombre");
